                                    ...
                                    <div class="text-center">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <img src="{{ asset('uploads/users/'.$user->pic) }}" data-src="holder.js/366x218/#fff:#000" class="img-responsive" width="366px" height="218px" />
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table  table-striped" id="users">
                                        ...
                                        <tr>
                                            <td>User Name</td>
                                            <td>
                                                <a href="#" data-pk="1" class="editable" data-title="Edit User Name">{{ $user->first_name . ' ' . $user->last_name }}</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                        ...
                                        <tr>
                                            <td>City</td>
                                            <td>
                                                <a href="#" data-pk="1"  class="editable" data-title="Edit City">{{ $user->city }}</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-3 col-xs-6">
                                                <div class="mag img-responsive">
                                                    <br /><a href="{{ route('admin.user.details', $friend->friend_id) }}" title="{{ $friend->friend->first_name . ' ' . $friend->friend->last_name }}">
                                                    <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('uploads/users/'. $friend->friend->pic) }}" alt=""></a></div>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                <ul class="nav nav-tabs ul-edit responsive">
                                    <li class="active">
                                        <a href="#tab-activity" data-toggle="tab">
                                            <i class="livicon" data-name="envelope" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> <!-- Activity --> Training
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#tab-friends" data-toggle="tab">
                                            <i class="livicon" data-name="user" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> <!-- Messages --> Freinds
                                        </a>
                                    </li>
                                    @if(Sentinel::getUser()->id == $user->id)
                                    <li style="float: right">
                                        <a href="#tab-friend-request" data-toggle="tab">
                                            <i class="livicon" data-name="user" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> <!-- Messages --> New Freind Request 
                                            @if(count($new_friends) > 0)
                                            <sup><span class="badge rounded" style="background-color: purple;">{{ count($new_friends) }}</span></sup>
                                            @endif
                                        </a>
                                    </li>
                                    <li style="float: right">
                                        <a href="#tab-message" data-toggle="tab">
                                            <i class="livicon" data-name="comments" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> Messages @if(count($notifications->filter(function($item){
                                                return $item->is_seen == 0;
                                            })) > 0)<sup><span class="badge rounded" style="background-color: green;">{{ count($notifications->filter(function($item){
                                                return $item->is_seen == 0;
                                            })) }}</span></sup>@endif
                                        </a>
                                    </li>
                                        ...
                                        <div class="activity">
                                            <table class="table table-striped table-advance table-hover web-mail" id="inbox-check">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                        <td><img src="{{ asset('uploads/courses/' . $course->image) }}" width="80"></td>
                                                ...
                                                <tr data-messageid="{{ $loop->index + 1 }}" class="unread">
                                                    ...
                                                    <td class="view-message">
                                                        <a href="{{ route('admin.user.details', $friend->friend_id) }}">
                                                            <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('uploads/users/'. $friend->friend->pic) }}" alt="" width="80">
                                                        </a>
                                                    </td>
                                                    <td  class="view-message ">
                                                        <a href="{{ route('admin.user.details', $friend->friend_id) }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr data-messageid="{{ $loop->index + 1 }}" class="unread">
                                                    ...
                                                    <td class="view-message">
                                                        <a href="{{ route('admin.user.details', $new_friend->friend_id) }}">
                                                            <img data-toggle="magnify" class="thumbnail img-responsive" src="{{ asset('uploads/users/'. $new_friend->friend->pic) }}" alt="" width="80">
                                                        </a>
                                                    </td>
                                                    <td  class="view-message ">
                                                        <a href="{{ route('admin.user.details', $new_friend->friend_id) }}">
                                                    ...
                                                    <td  class="view-message text-right">
                                                        <form action="{{ route('admin.user.friendrequest', $new_friend->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pd-top">
                                                <table class="table table-striped table-advance table-hover web-mail" id="inbox-check">
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="3"><h3>Notifications from Admin</h3></td>
                                                        </tr>
                                                        ...
                                                        <tr data-messageid="{{ $loop->index + 1 }}" class="unread">
                                                            ...
                                                            <td class="view-message">
                                                                <a href="{{ $notification->push_notification->link }}"  target="_blank" style="color: {{ $notification->is_seen == 0 ? 'green' : ''  }};" @if($notification->is_seen == 0)  onclick="seen({{$notification->id}})" @endif>
