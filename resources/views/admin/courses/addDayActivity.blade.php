...
<section class="content paddingleft_right15">
    <div class="container-fluid">
        <div class="welcome">
            <h3>Course Day Activities<a href="{{ URL('admin/courses') }}" class="btn btn-info pull-right">Go Back to Courses</a></h3>
        </div>
                    ...
                    @for($y = 1; $y <= $course->week_a_days; $y++)
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-toggle="modal" class="btn btn-primary" data-href="#responsive" href="#responsive_{{ $x.$y }}">
                                    <span class="fa fa-plus"></span> Add
                                </a>
                                <div class="modal fade in" id="responsive_{{ $x.$y }}" tabindex="-1" role="dialog" aria-hidden="false">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form  action="{{ url('courses/addActivity') }}" enctype="multipart/form-data" method="POST" class="form-horizontal">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="detail" required rows="5" placeholder="Add Week-{{ $x }} Day-{{ $y }} activity detail"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
