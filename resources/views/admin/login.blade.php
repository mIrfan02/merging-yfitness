                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('signin') }}" autocomplete="on" method="post" role="form" id="login_form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/logo.png') }}" width="150" alt="Yfitness logo">
                                    <br>Log In</h3>
                                    <!-- CSRF Token -->
                        ...
                        <div id="register" class="animate form">
                            <form action="{{ route('signup') }}" autocomplete="on" method="post" role="form" id="register_here">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/logo.png') }}" width="150" alt="josh logo">
                                    <br>Sign Up</h3>
                                    <!-- CSRF Token -->
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        ...
                        <div id="forgot" class="animate form">
                            <form action="{{ url('admin/forgot-password') }}" autocomplete="on" method="post" role="form" id="reset_pw">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/logo.png') }}" width="150" alt="josh logo"><br>Forgot Password</h3>
                                <p>
