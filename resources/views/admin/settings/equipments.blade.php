...
<section class="content paddingleft_right15">
    <button class="btn btn-raised btn-primary " data-toggle="modal" data-target="#add">
        <span class="fa fa-plus"></span> Add New Equipments
    </button>
    <div class="modal fade modal-fade-in-scale-up" tabindex="-1" id="add" role="dialog" 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form  action="{{ url('admin/settings/equipments') }}" method="POST" class="form-horizontal">
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title" id="modalLabelfade">Add New Equipments</h4>
                    </div>
    ...
    <div class="row">
        <div class="panel panel-primary ">
            <div class="panel-heading">
                <h4 class="panel-title">Equipments List</h4>
            </div>
            <br />
                        ...
                        @if(count($categories))
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        @include('admin.settings.editequipment')
                                        @include('admin.settings.statusequipment')
                                    </td>
                                </tr>
                            @endforeach
                        @endif
