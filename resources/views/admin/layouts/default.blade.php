...
<header class="header">
    <a href="{{ route('admin.dashboard') }}" class="logo">
        <img src="{{ asset('assets/img/logo.jpeg') }}" alt="logo" width="150">
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- Menu Body -->
                        <li>
                            <a href="{{ url('admin/users/show/'.Sentinel::getUser()->id) }}">
                        ...
                        <li>
                            <a href="{{ url('admin/users/edit/'.Sentinel::getUser()->id) }}">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url('lockscreen/'.Sentinel::getUser()->id) }}">
