                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <img src="{{ asset('assets/images/banner/'.$banner->image) }}" width="100">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <button type="submit" class="btn btn-success">@lang('banner/form.change')</button>
                        </div>
                    </div>
                </div>
            </form>
